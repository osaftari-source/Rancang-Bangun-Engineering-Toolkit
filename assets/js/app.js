...
(() => {
  ...
  const tools = {
    ...
    piping: {
      ...
      cards: [
        ...
        {
          title: "Pipe Support Span Calculator",
          description: "Estimate preliminary allowable support spacing and vertical distributed load for site survey use.",
  ...
  window.addEventListener("beforeinstallprompt", event => {
    ...
    if (!sessionStorage.getItem("hub-install-dismissed")) installPrompt.classList.remove("hidden");
  });
  ...
  async function registerServiceWorker() {
    ...
    try {
      ...
      // The tools page remains usable when service worker registration fails.
    }
  }
